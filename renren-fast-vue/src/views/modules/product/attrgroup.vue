    ...
    <el-row :gutter="20">
        ...
        <el-col :span="20">
            <div class="mod-config">
                <el-form :inline="true" :model="dataForm" @keyup.enter.native="load()">
                    <el-form-item>
                ...
                <!-- 弹窗, 新增 / 修改 -->
                <add-or-update v-if="addOrUpdateVisible" ref="addOrUpdate" @refreshDataList="load"></add-or-update>

                <!-- 修改关联关系 -->
                <relation-update v-if="relationVisible" ref="relationUpdate"
                                 @refreshData="load"></relation-update>
            </div>
        </el-col>
    </el-row>
</template>
